...
export const I18N: Record<Lang, I18nShape> = {
  ko: {
    ...
    brand: "이거 해봄?",
    tabs: { hot: "오늘의 HOT", new: "최신순", popular: "인기순", likes: "좋아요순" },
    catToggle: "카테고리별 보기",
    allCategory: "전체",
    sortCaptions: {
    ...
    photoNotice: "📷 사진이 필요한 프롬프트예요. 이동 후 직접 사진을 첨부해주세요.",
    deeplinkBtn: "➜ 딥링크로 바로 열기",
    copyBtn: "복사하기",
    openAppBtn: "앱/웹으로 이동",
    doneLabel: "나도 해봄 ✓",
    copyFail: "복사 실패 - 직접 선택해주세요",
    disclaimer: "AI 결과물의 특성상 같은 프롬프트라도 실행할 때마다 다른 결과가 나올 수 있어요.",
    themeDark: "🌙 다크",
    themeLight: "☀️ 라이트",
    ...
    onboardStart: "시작하기",
    onboardBody:
      "요즘 사람들이 AI로 뭘 해보고 있는지 발견하고, 내 상황에 바로 적용해볼 수 있는 곳이에요.\n\n마음에 드는 걸 고르면 필요한 정보만 채워서 바로 실행하거나, 복사해서 원하는 AI에 붙여넣기만 하면 돼요.",
    showTranslation: "번역 보기",
    hideTranslation: "번역 숨기기",
    translationNote: "참고용 번역이에요 · 실제로 복사·전송되는 내용은 원문 그대로예요.",
  },
  en: {
    updateNotice: "Curated sample data · live auto-refresh pipeline in progress",
    brand: "DiDYOUTRYiT?",
    tabs: { hot: "Today's HOT", new: "Newest", popular: "Popular", likes: "Most Liked" },
    ...
    photoNotice: "📷 This prompt needs a photo. Please attach it yourself after you get there.",
    deeplinkBtn: "➜ Open directly",
    copyBtn: "Copy",
    openAppBtn: "Open app/web",
    doneLabel: "Tried it ✓",
    copyFail: "Copy failed - please select manually",
    disclaimer: "AI results vary — the same prompt can produce a different result each time.",
    themeDark: "🌙 Dark",
    themeLight: "☀️ Light",
    slotFallback: (label) => `[${label}]`,
    ...
    translationNote: "Reference translation only · what actually gets copied or sent stays in the original language.",
  },
};
